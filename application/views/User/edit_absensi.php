...
<div class="container">
	...
	<form class="form-horizontal" action="<?php echo base_url('User_C/update_absensi_ku')?>" method="POST">
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-10 input-group clockpicker" data-align="top" data-autoclose="true" data-placement='top'>
		      	<input type="text" class="form-control" value="<?php echo $key->jam ?>" name="u_jam">
