...
define("DOMPDF_DIR", str_replace(DIRECTORY_SEPARATOR, '/', FCPATH."application/libraries/dompdf"));
define("TEMP_FOLDER", str_replace(DIRECTORY_SEPARATOR, '/', FCPATH."application/libraries/dompdf"));
